...
public class BookController {
    ...
    public ResponseEntity<?> rentalBook(@PathVariable int bookListId, @RequestBody Map<String, Integer> map) {

        return ResponseEntity.ok(bookService.rentalBook(bookListId, map.get("memberId")));
    }
