...
const BookRegister = () => {
    ...
    const pagination = () => {
        ...
        const startIndex = nowPage % 5 === 0
            ? nowPage - 4 : nowPage - (nowPage % 5) + 1;
            ...
            <>
                ...
                {pageNumbers.map(pageNumber => (
                    (<button key={pageNumber} onClick={() => {
                        ...
                        setRefresh(true);
                    }} disabled={pageNumber === nowPage}>{pageNumber}</button>)))}
    ...
    return (
        <div>
            ...
            <div>
                <label>도서검색</label>
                <input type="search" onChange={searchInputHandle} onKeyUp={searchSubmitHandle}/>
